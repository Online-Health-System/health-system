...
function renderDashboard() {
  ...
  <div class="glass-table">
    ...
    <table>
      <thead>
        <tr>
          <th>Name</th><th>Specialty</th><th>Status</th>
          <th>Email</th><th>Phone</th><th>Clinic Room</th>
        </tr>
      </thead>
      <tbody>`;
    ...
    <table>
      <thead>
        <tr>
          ...
          <th>Blood Type</th><th>Chronic Diseases</th>
          <th>Assigned Doctor</th><th>Visits</th>
        </tr>
      </thead>
      <tbody>`;
  ...
  if (role === 'doctor') {
    ...
    appsToShow = DB.appointments.filter(a => a.patientId === currentUser.id);
  }
